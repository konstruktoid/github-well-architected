...
draft: false
title: 'Essentials of governance and administration with GitHub Enterprise'
...
{{< callout type="info" >}}
Enterprise policy and settings require ongoing maintenance and review to make sure that they are up to date and meet the evolving needs of your organization. For more details, see [governance policies best practices](./governance-policies-best-practices) page.
{{< /callout >}}
...
{{< callout type="info" >}}
Branch protection rules are a legacy method of mergeability control. Rulesets are more flexible and functional and are the preferred approach going forward. For deep guidance on rulesets, see [repository rulesets best practices](./managing-repositories-at-scale/rulesets-best-practices) page.
{{< /callout >}}
...
- [Governance policies best practices](./governance-policies-best-practices)
