...
1. **Change sets for cross-repo coordination**
...
1. **Branching and merge coordination model**
...
1. **Reusable workflows as a versioned platform interface**
...
1. **Component releases vs. system releases**
...
1. **Orchestration with a safety model**
...
- [Exploring repository architecture strategy](./scaling-git-repositories/repository-architecture-strategy)
